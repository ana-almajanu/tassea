...
??? note "Noi.2 Cafe – Coffess Shop Owner Interview – Ana (Intervievator)"
...
??? note "MUGSHOT – Coffess Shop Owner Interview – Ana (Intervievator)"
...
??? note "Loom68 – Coffess Shop Owner Form Answers"
...
??? note "Transcriere Interviu – Ana (Intervievator) & Ilinca (Participant)"
...
??? note "Transcriere Interviu – Ana (Intervievator) & Vlad (Participant)"
...
In addition to the qualitative MVP interview, we also collected **structured feedback via two short surveys**—one for **customers (4 responses)** and one for **café staff/employees (2 responses)**—to validate usability and willingness-to-pay signals across both sides of the product. Customer results show that the MVP concept is **easy to understand** (3/4 rated clarity **10/10**) and that the unified rewards wallet is strongly valued (3/4 rated usefulness **10/10**), while the remaining outlier indicates we still need clearer onboarding for less motivated users. On the “real-life usage” side, QR at checkout was seen as acceptable but **context-dependent** (answers included “Depinde” and “Nu”), and the favourites incentive model was generally understood (ratings ranged from **4–10**, with most answers high). The favourites “locked until claim” rule split opinion (**50% neutral / 50% frustrating**), which supports iterating toward a softer reset option. Importantly, **3 out of 4 customers said they would pay** a small monthly price for faster rewards + centralized loyalty (values ranged from **5–15 RON/month**, with one “0 RON” response). Staff feedback was also highly positive: both respondents rated business value clarity **10/10**, preferred **QR scanning** as the checkout method, saw the favourites multiplier as effective (**9–10/10**), and reported **no deal-breakers**, with suggested pilot requirements focusing mainly on scalability (supporting many cafés) and making the experience “a bit more dynamic.” These survey spreadsheets are attached as evidence and document the raw answers used for this milestone.
